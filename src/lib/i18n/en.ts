...
export const en: Record<TranslationKey, string> = {
  ...
  "hc.transcribing": "Transcribing…",
  "hc.micError": "Couldn't access the microphone",
  "hc.voiceOn": "Read replies aloud",
  "hc.voiceOff": "Mute voice",
  "hc.attach": "Attach photos",
  "hc.logo": "Logo",
  "hc.attachHint": "Drag images or use the clip",
